...
public class MusicView4 extends View {
     ...
     * 但高于一定限度后人眼察觉不出。
     */
    private static final int SAMPLING_SIZE = 3;
    /**
     * 采样点的X
     */
    ...
    public MusicView4(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public MusicView4(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                    return size;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawCircle(center, center, center - circleWidth, paintCircle);
        if (width == 0 || height == 0){
           return;
        }
        float x, y ;
...
//            }
            ...
            switch (i){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    y = (100 - lineHeight) / 100f * minHeight;
                    break;
                default:
                    y = lineHeight / 100f * minHeight;
                    break;
