...
package com.zs.various.view.datetimepicker.adapter;
...
public class NumericWheelAdapter extends AbstractWheelTextAdapter {
    ...
    private int mFlag; // 0:默认  1: 上午 下午
    ...
    public NumericWheelAdapter(Context context, int minValue, int maxValue, int flag, String format) {
        super(context);
