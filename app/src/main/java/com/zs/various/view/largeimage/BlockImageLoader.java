 ...
 */
package com.zs.various.view.largeimage;
...
import com.zs.various.view.largeimage.factory.BitmapDecoderFactory;
...
public class BlockImageLoader {
    ...
    private static Pools.SynchronizedPool<Bitmap> bitmapPool = new Pools.SynchronizedPool<>(1);
    ...
    private void release(LoadData loadData) {
        ...
        if(loadData.task != null && loadData.task.decoder != null) {
            loadData.task.decoder.recycle();
        }
    ...
    public void stopLoad() {
        if (mLoadData != null) {
            ...
            if (currentScaleDataMap != null) {
                ...
                recycleMap(currentScaleDataMap);
...
//        图片没被位移，那么屏幕上显示横向2列，纵向getDisplayMetrics().heightPixels/BASEBLOCKSIZE行
        ...
        if (loadData.currentScaleDataMap == null) {
            loadData.currentScaleDataMap = new HashMap<>(8);
        }
        /*
